...
const employees = [
  {
    ...
    documents: JSON.stringify(['docs/john_cv.pdf', 'docs/john_id.pdf']),
  },
  {
    ...
    documents: JSON.stringify(['docs/jane_cv.pdf']),
  },
  {
    ...
    documents: JSON.stringify(['docs/alice_cv.pdf', 'docs/alice_id.pdf']),
  },
];
